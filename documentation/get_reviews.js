/**
 * @api {get} /reviews/get_reviews/ Get Reviews
 * @apiName get_reviews
 * @apiGroup Review
 * @apiVersion 0.3.0
 * @apiDescription Get highest ranked reviews for a specific place. Reviews returned from this API call are sorted based on the ranked score.
 *
